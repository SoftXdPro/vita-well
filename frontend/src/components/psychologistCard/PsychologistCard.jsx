...
const PsychologistCard = ({ name, specialty, image }) => {
    ...
    return (
        <div className="max-w-sm rounded overflow-hidden shadow-lg mx-4 my-4 bg-white">
            ...
            <div className="px-6 py-4">
                <div className="font-bold text-3xl mb-2 text-blue-700">Psychologist</div>
            ...
            {showPopup && (
                <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
                    <div className="bg-white p-6 rounded-lg w-96">
                        <h2 className="text-2xl font-semibold mb-4 text-yellow-400">Book Therapy Session</h2>
